...
public class FurnitureSlotFurnitureTakeEvent extends PlayerEvent implements Cancellable {
    ...
    public FurnitureSlotFurnitureTakeEvent(Player player, Furniture furniture, SlotDefinition slot, Furniture nested) {
        super(player);
